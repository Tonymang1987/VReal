...
// TMD27713 I2C address is 39(57)
#define Addr 0x39

const int LEDpin = 6;//Digital pin 6
int LCDpin = 9;//Digital pin 9
 int relayPin = 4;
...
pinMode(LCDpin, OUTPUT); //Initialize led as output
